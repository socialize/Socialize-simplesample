...
stage_consumer_key="e8d3c6b2-6cef-483d-ba13-1127030a5575"
stage_consumer_secret="a3f06467-cc9a-4b92-a9a3-a1f04599d073"
...
socialize.c2dm.sender.id=champ.somsuk@getsocialize.com
...
function config_stage(){
    ...
    replace com.socialize.sample.simple.permission.C2D_MESSAGE com.socialize.sample.simple.stage.permission.C2D_MESSAGE $menifest_file  
}
